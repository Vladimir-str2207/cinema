...
export class MovieController {
  ...
  async update(
    @Param('id') id: string,
    @Body() { title, year, duration, genre, director, poster_path,video_path, description }: UpdateMovieDto,
  ) {
    return this.movieService.update(id, { title, year, duration, genre, director, poster_path,video_path, description });
  }
